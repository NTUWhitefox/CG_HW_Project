...
//========================================================================
{
	...
	begin();	// add to this widget
	{
		...
		waveBrowser = new Fl_Browser(605,pty,160,100, "Waveforms");//switch between sine wave, height maps and noise
		waveBrowser->type(2);
		...
		amplitudeSlider = new Fl_Value_Slider(605,pty,160,20,"Amplitude");
		amplitudeSlider->range(0,1);
		amplitudeSlider->value(0.5);
		amplitudeSlider->align(FL_ALIGN_LEFT);
		amplitudeSlider->type(FL_HORIZONTAL);

		pty+=30;

		waveLengthSlider = new Fl_Value_Slider(605,pty,160,20,"Wavelength");
		waveLengthSlider->range(0,1);
		waveLengthSlider->value(0.5);
		waveLengthSlider->align(FL_ALIGN_LEFT);
		waveLengthSlider->type(FL_HORIZONTAL);
